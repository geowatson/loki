...
* [9995](https://github.com/grafana/loki/pull/9995) **chaudum**: Delay the first period flush operation by a random duration to prevent multiple ingesters started at the same time to flush at the same time.
